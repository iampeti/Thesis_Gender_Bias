...
design
colnames(design) = c("f_c","f_d","m_c","m_d")
design


# female control vs Female disease) vs (Male control VS Male disease)
# how much the disease  effect in males differs from the alcoholism effect in females
#

contrasts=makeContrasts((f_c-f_d)-(m_c-m_d), levels = colnames(design))
contrasts
