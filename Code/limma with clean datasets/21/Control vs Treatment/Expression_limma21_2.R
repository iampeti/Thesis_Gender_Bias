...
design
colnames(design)=c("con_f_o","con_m_mid","con_m_y","diab_f_m","diab_f_o","diab_m_o")
design


contrasts=makeContrasts((con_f_o+con_m_mid+con_m_y)-(diab_f_m+diab_f_o+diab_m_o),
...
write.csv(expr_levels, "expr_levels21_CvT.csv", row.names = FALSE)
