...
group=paste(factors$tissue,factors$gender,factors$age)
...
design
colnames(design)=c("cancer_f_old","cancer_f_y","cancer_m_old","cancer_m_y","control_f_old","control_m_old")
design




contrasts=makeContrasts( c(cancer_f_old+cancer_f_y+cancer_m_old+cancer_m_y)-(control_f_old+control_m_old)
...
write.csv(expr_levels, "expr_levels19_CvT.csv", row.names = FALSE)
