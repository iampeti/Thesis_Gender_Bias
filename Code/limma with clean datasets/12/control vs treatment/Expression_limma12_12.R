...
design
colnames(design) = c("IBS_f","IBS_m","UC_f","UC_m")
design




contrasts=makeContrasts((IBS_f+IBS_m) -(UC_f+UC_m), levels = colnames(design))
contrasts
...
write.csv(expr_levels, "expr_levels12.csv", row.names = FALSE)
