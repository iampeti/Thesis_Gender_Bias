...
design
colnames(design)=c("Alz_f","Alz_m","control_f","control_m")
design

contrasts=makeContrasts((Alz_f+Alz_m)-(control_f+control_m), levels = colnames(design))
contrasts
...
write.csv(expr_levels, "expr_levels30_CvT.csv", row.names = FALSE)
