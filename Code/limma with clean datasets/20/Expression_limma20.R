...
contrasts=makeContrasts((groupfemale_control-groupfemale_schizophrenia)-(groupmale_control-groupmale_schizophrenia) , levels = colnames(design))
contrasts
...
write.csv(expr_levels, "expr_levels20.csv", row.names = FALSE)
