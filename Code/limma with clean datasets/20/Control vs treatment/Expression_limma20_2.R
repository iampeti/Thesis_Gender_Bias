...
design
colnames(design)=c("control_f","control_m","schizo_f","schizo_m")



contrasts=makeContrasts((control_f+control_m)-(schizo_f+schizo_m), levels = colnames(design))
contrasts
...
write.csv(expr_levels, "expr_levels20_CvT.csv", row.names = FALSE)
