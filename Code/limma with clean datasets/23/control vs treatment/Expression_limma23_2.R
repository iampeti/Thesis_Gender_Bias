...
design
colnames(design)=c("con_f_ome","con_f_sub","con_m_ome","con_m_sub","res_f_ome","res_f_sub","res_m_ome","res_m_sub")
design


contrasts=makeContrasts((con_f_ome+con_f_sub+con_m_ome+con_m_sub)-(res_f_ome+res_f_sub+res_m_ome+res_m_sub),
...
write.csv(expr_levels, "expr_levels23_CvT.csv", row.names = FALSE)
