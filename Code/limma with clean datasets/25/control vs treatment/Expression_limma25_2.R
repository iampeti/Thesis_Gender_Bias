...
design
colnames(design)=c("res_f_om","res_f_sub","res_m_om","res_m_sub","sen_f_om","sen_f_sub")
design


contrasts=makeContrasts((res_f_om+res_f_sub)-(sen_f_om+sen_f_sub),levels=colnames(design))
contrasts
...
write.csv(expr_levels, "expr_levels25_CvT.csv", row.names = FALSE)
