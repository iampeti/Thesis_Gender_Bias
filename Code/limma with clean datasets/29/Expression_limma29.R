...
contrasts=makeContrasts((groupfemale_control-groupfemale_Parkinsons)-(groupmale_control-groupmale_Parkinsons) , levels = colnames(design))
contrasts
...
write.csv(expr_levels, "expr_levels29.csv", row.names = FALSE)
