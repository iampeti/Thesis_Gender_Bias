...
design
colnames(design)=c("control_f","control_m","park_f","park_m")
design



contrasts=makeContrasts((control_f+control_m)-(park_f+park_m) , levels = colnames(design))
contrasts
...
write.csv(expr_levels, "expr_levels29_CvT.csv", row.names = FALSE)
