...
design=model.matrix(~0+factors$age)
design
colnames(design)=c("ancient","middle","old","young")



contrasts=makeContrasts( (ancient+old)-(middle+young),
...
write.csv(expr_levels, "expr_levels15_CvT.csv", row.names = FALSE)
